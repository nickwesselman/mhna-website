...
const Home: NextPage<HomeProps> = ({ hero } : HomeProps) => {
  return (
    <div>
      <Head>
        <title>Malvern Hills Neighborhood Association</title>
          ...
          <div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
            <div className="relative flex flex-col md:flex-row">
              <a href="#_" className="flex items-center mb-5 font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0">
                <span className="mx-auto text-xl font-black leading-none text-gray-900 select-none">tails<span className="text-indigo-600">.</span></span>
              </a>
            ...
            <div className="inline-flex items-center ml-5 space-x-6 lg:justify-end">
              <a href="#" className="text-base font-medium leading-6 text-gray-600 whitespace-no-wrap transition duration-150 ease-in-out hover:text-gray-900"></a>
              <a href="#" className="justify-center text-base font-medium leading-6"></a>
            </div>
          </div>
        </section>

        <section className="px-2 bg-white md:px-0 py-8">
            ...
            <div className="flex flex-wrap items-center sm:-mx-3">
              ...
              <div className="w-full md:w-1/2 md:px-3">
                <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                  <div className="prose lg:prose-xl">
                    <ReactMarkdown children={hero.content} />
                  </div>
                  <div className="relative flex flex-col sm:flex-row sm:space-x-4">
                    <a href={hero.data.link} className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
                      {hero.data.linkText}
                    </a>
                  </div>
                </div>
              ...
              <div className="w-full md:w-1/2">
                <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                  <img src={hero.data.image} className="" />
                </div>
              </div>
...
export const getStaticProps: GetStaticProps<HomeProps> = async (context) => {
  const markdown = `---
# image: malvern_hills_crest.png
# image: https://cdn.devdojo.com/images/november2020/hero-image.jpeg
image: /malvern_hills_satellite.jpg
link: /events
linkText: Register Now →
---
# Hello World
Lorem ipsum _dolor_ sit. Nunc etam.
`;
